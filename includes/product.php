          ...
          <div class="col-sm-4" style="padding: 20px;">
            ...
            <div class="card card-5 " data-toggle="modal" data-target="#myModal<?php echo $row["product_id"]; ?>">
              ...
              <img class="card-img-top border-bottom border-primary"
                src="assets/image/store/<?php echo $row["product_image"] ?>" alt="Card image cap">
              <div class="card-body">
                ...
                <a class="card-link fonts" style="color:green;margin-left: 100px">
              ...
              <form action="includes/addcart.php" method="post">
                ...
                <button type="submit" class="btn btn-danger btn-lg btn-block"
                  style="padding-top: 15px;padding-bottom: 15px;" name="addcart">Add To Cart <i
                  ...
                  <div class="modal-body">
                    ...
                    <form action="includes/addcart.php" method="post">
                      ...
                      <button type="submit" class="btn btn-success btn-lg btn-block"
                        style="padding-top: 15px;padding-bottom: 15px;" name="addcart">Buy<i
                          class="fas fa-shopping-cart fa-1x"></i></button>
                    </form>
                  </div>
                </div>
