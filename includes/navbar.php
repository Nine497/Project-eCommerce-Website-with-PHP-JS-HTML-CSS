  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
      ...
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="index.php"><i class="fas fa-home"> </i>
            <?php echo $home ?> <span class="sr-only">(current)</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <div class="dropdown show">
              ...
              <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item " href="profile.php"><i class="far fa-address-card"></i>
                  <?php echo $changeprofile ?>
                </a>
          ...
          <li class="nav-item dropdown active">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
              ...
              <?php echo $cart; ?> <i class="fas fa-shopping-cart fa-1x "></i>
              <div class="itemcount">
    ...
    <?php } else { ?>
      ...
      <div class="form-inline my-2 my-lg-0">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link " href="login.php" data-toggle="modal" data-target="#mySignin">
              <?php echo $signin ?><span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link " href="php/register.php" data-toggle="modal" data-target="#mySignup">
              <?php echo $signup ?> <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item active">
            <a href="?lang=th" class="flag-icon flag-icon-th nav-link"></a>
