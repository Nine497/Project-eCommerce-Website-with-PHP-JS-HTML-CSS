...
<body>
    ...
    <div class="container">
        ...
        ?>
        <form class="form-horizontal" id="myform1" name="form" action="?data=confirm" method="POST"
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="mem_fname"
                                            value="<?php echo $row['mem_fname'] ?>">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="mem_lname">
                                            <?php echo $lname; ?>
                                ...
                                <div class="form-group">
                                    <label for="mem_address">
                                        <?php echo $add; ?>
                                    </label>
                                    <textarea class="form-control" name="mem_address"
                                        rows="5"><?php echo $row['mem_address'] ?> </textarea>
                                </div>
                                <a href="profile.php" class="btn btn-warning float-left">ย้อนกลับ</a>
                                <div class="text-right">
                                    <button class="btn btn-info btn-grad btn-xl" id="confirm_edit">ตกลง</button>&nbsp;
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.getElementById("confirm_edit").addEventListener("click", async function (event) {
            event.preventDefault();
            // Open the Sweet Alert
            const result = await Swal.fire({
                title: "ยืนยันการเปลี่ยนแปลง?",
                text: "คุณแน่ใจหรือไม่ว่าต้องการยืนยันการเปลี่ยนแปลงโปรไฟล์นี้",
                icon: "warning",
