...
<body>
    ...
    <div class="container" style="background-color:white;">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                while ($rows = mysqli_fetch_array($result1)) { ?>
                    <tr>
                        ...
                        <td> <a href="includes/delcart.php?cart_id=<?php echo $rows['cart_id'] ?>" class="delcart"
                                style="font-size:23px"><i class="fas fa-times" style="color:red"></i></a></td>
                    </tr>
            ...
            <br><br><br><br><br><br><br><br><br><br><br><br><a href="order.php" class="btn btn-success"
                style="margin-left: 970px;">
                <?php echo $continue ?>
            </a>
            <br><br>
        </div>
