...
<body>
    ...
    if ($show2['order_status'] == 0) {
        $status = '<span class=text-wrning>รอชำระเงิน</span>';
    } else if ($show2['order_status'] == 1) {
    ...
    <div class="container">
        <div>
            ...
            <h4>
                <center>ใบสั่งซื้อสินค้า
            </h4><br></center>

            <center>
                <div class="row">
                    <div class="col-sm">
                        <div style="text-align: left;font-weight:bold;">ข้อมูลลูกค้า</div>
                        <div style="text-align: left;"> ชื่อ :
                            <?php echo $_SESSION['mem_fname'] . " " . $_SESSION['mem_lname']; ?>
                        </div>
                        <div style="text-align: left;">เบอร์ :
                            <?php echo $row1['mem_tel']; ?>
                        </div>
                        <div style="text-align: left;">อีเมลล์ :
                            <?php echo $row1['mem_email']; ?>
                        </div>
                        <div style="text-align: left;">ที่อยู่ :
                            <?php echo $row1['mem_address']; ?>
                        </div>
                    ...
                    <div class="col-sm">
                        <div style="text-align: left;font-weight:bold;">วันที่สั่งซื้อ :
                            <?php echo $show2['order_date'] ?>
                        </div>
                        <div style="text-align: left;font-weight:bold;"> เลขที่สั่งซื้อ :
                            <?php echo $_REQUEST['order_number']; ?>
                        </div>
                        <div style="text-align: left;font-weight:bold;">สถานะ :
                            <?php echo $status; ?>
                        </div>
                    </div>
                </div>
                ...
                <table border=1 class="table table-striped table-bordered" id="table_example">
                    ...
                    <tr>
                        ...
                        <td colspan="5"
                            style="text-align: right;padding-bottom: 10px;padding-top: 10px;padding-left: 10px;padding-right: 10px;">
                            <h5>ค่าจัดส่ง: <span class="text-success">(
                                    <?php echo $shipping ?>)
                                </span></h5>
                        </td>
                        <td style="padding-bottom: 10px;padding-top: 10px;padding-left: 10px;padding-right: 10px;">
                            <h5>
                                <?php echo number_format($totalshipping, 2) ?> บาท
                            </h5>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5"
                            style="text-align: right;padding-bottom: 10px;padding-top: 10px;padding-left: 10px;padding-right: 10px; ">
                            <h5 style="    color: green;">รวมค่าใช้จ่ายที่ต้องชำระทั้งหมด: </h5>
                        </td>
                        <td style="padding-bottom: 10px;padding-top: 10px;padding-left: 10px;padding-right: 10px;">
                            <h5 style="    color: green;">
                                <?php echo number_format($totalsum, 2) ?> บาท
                            </h5>
                        </td>
                    </tr>
                ...
                <input type="button" name="Button" value="Print"
