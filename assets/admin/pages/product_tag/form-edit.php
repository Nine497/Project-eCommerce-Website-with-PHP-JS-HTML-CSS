          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">แก้ไขยี่ห้อสินค้า</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title d-inline-block">แก้ไขยี่ห้อสินค้า</h3>
          </div>
          <!-- /.card-header -->
                ...
                <table>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="product_tag_name" name="product_tag_name"
                      value="<?php echo $row['product_tag_name'] ?>" disabled>
                  </div>
                  <div class="form-group col-md-12">
                    <div class="card-footer">
                      <a href=form-edit2.php?product_tag_id=<?php echo $row['product_tag_id'] ?>"
