                  ...
                  <div class="form-group col-md-2">
                    ...
                    <select class="form-control" name="product_tag">
                      ...
                      while ($rows = mysqli_fetch_assoc($res)) {
                        ?>
                        <option value="<?php echo $rows['product_tag_name'] ?>"><?php echo $rows['product_tag_name'] ?>
                        </option>
                      <?php } ?>
                    </select>
                  </div>
  ...
  $(document).ready(function () {
    $('#formRegister').validate({
      ...
      messages: {
        ...
        product_code: 'โปรดกรอก โค๊ดสินค้า',
        product_tag: 'โปรดกรอก  แท๊กสินค้า',
        product_count: number: 'กรอกแต่ตัวเลขเท่านั้น',
