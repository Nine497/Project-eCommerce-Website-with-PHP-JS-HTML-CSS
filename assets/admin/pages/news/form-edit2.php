      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title d-inline-block">แก้ไขข่าวสาร</h3>
          </div>
          <!-- /.card-header -->
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <figure class="figure text-center mt-2">
                    <input type="hidden" class="form-control" id="new_id" name="new_id"
                      value="<?php echo $rows['new_id'] ?>">
                    <input type="hidden" class="form-control" id="new_image1" name="new_image1"
                      value="<?php echo $rows['new_image'] ?>">
                    <img src="../../../image/news/<?php echo $rows['new_image'] ?>" id="imgUpload"
                      class="figure-img img-fluid rounded" style="max-width:50%">
                  </figure>
                </div>
                <table>
                  <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" id="new_title" name="new_title"
                      value="<?php echo $rows['new_title'] ?>">
                  </div>
                  <div class="form-group col-md-2">
                    <label for="new_date">วันที่ข่าวสาร</label>
                    <input type="date" class="form-control" id="new_date" name="new_date"
                      value="<?php echo $rows['new_date'] ?>">
                  </div>
                  <div class="card-footer col-md-12">
                    <a href="index.php" class="btn btn-warning float-left">ย้อนกลับ</a>
                    <input type="submit" name="submit" class="btn btn-primary float-right" value="บันทึก">
                  </div>
                </table>
              </div>
            </div>
